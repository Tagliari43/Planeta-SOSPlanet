  ...
  return (
    <div className="pt-32 pb-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen">
      ...
      >
        ...
        <h1 className="text-4xl font-bold mb-8 text-gray-900 dark:text-white">Política de Privacidade</h1>
        ...
        <div className="bg-gray-50 dark:bg-[#0C1611]/80 backdrop-blur-sm border border-gray-200 dark:border-green-900/30 p-8 rounded-2xl">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-green-300">1. Coleta de Dados</h2>
          <p className="text-gray-600 dark:text-green-100/70 mb-6">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
          </p>
          
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-green-300">2. Uso das Informações</h2>
          <p className="text-gray-600 dark:text-green-100/70 mb-6">
            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
          </p>

          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-green-300">3. Transparência</h2>
